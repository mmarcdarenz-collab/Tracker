...
const VERSION = "marc-v29-input-history-progress-fix-v1";
...
self.addEventListener("activate", event => {
  event.waitUntil((async()=>{
    ...
    await Promise.all(keys.filter(k=>!keep.has(k) && (k.startsWith("marc-v26-")||k.startsWith("marc-v27-")||k.startsWith("marc-v28-")||k.startsWith("marc-v29-"))).map(k=>caches.delete(k)));
